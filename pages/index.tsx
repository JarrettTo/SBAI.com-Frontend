...
const HomePage = () => {
    ...
    const fetchGamePredictions = async () => {
        ...
        setGamePreds([{"away_team":"New Orleans Pelicans","home_team":"Detroit Pistons","id":"0","ml_conf":"74.4%","ml_pred":"New Orleans Pelicans","ou_conf":"57.0%","ou_pred":"UNDER 218"},{"away_team":"Philadelphia 76ers","home_team":"LA Clippers","id":"1","ml_conf":"79.2%","ml_pred":"LA Clippers","ou_conf":"65.0%","ou_pred":"OVER 214.5"},{"away_team":"Cleveland Cavaliers","home_team":"Miami Heat","id":"2","ml_conf":"50.5%","ml_pred":"Miami Heat","ou_conf":"73.1%","ou_pred":"OVER 203.5"},{"away_team":"Oklahoma City Thunder","home_team":"Milwaukee Bucks","id":"3","ml_conf":"57.2%","ml_pred":"Milwaukee Bucks","ou_conf":"67.8%","ou_pred":"UNDER 232.5"},{"away_team":"Golden State Warriors","home_team":"Minnesota Timberwolves","id":"4","ml_conf":"79.7%","ml_pred":"Minnesota Timberwolves","ou_conf":"51.0%","ou_pred":"UNDER 220"},{"away_team":"Indiana Pacers","home_team":"Los Angeles Lakers","id":"5","ml_conf":"62.2%","ml_pred":"Los Angeles Lakers","ou_conf":"50.0%","ou_pred":"OVER 241.5"}])
    };
    useEffect(() => {
