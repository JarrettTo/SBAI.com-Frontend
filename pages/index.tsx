...
const HomePage = () => {
    ...
    const fetchGamePredictions = async () => {
        ...
        setGamePreds([{"away_team":"Phoenix Suns","home_team":"Boston Celtics","id":"0","ml_conf":"73.2%","ml_pred":"Boston Celtics","ou_conf":"52.0%","ou_pred":"UNDER 227"},{"away_team":"Los Angeles Clippers","home_team":"Chicago Bulls","id":"1","ml_conf":"62.5%","ml_pred":"Los Angeles Clippers","ou_conf":"57.0%","ou_pred":"UNDER 214.5"},{"away_team":"Washington Wizards","home_team":"Houston Rockets","id":"2","ml_conf":"79.0%","ml_pred":"Houston Rockets","ou_conf":"63.6%","ou_pred":"UNDER 225.5"},{"away_team":"Philadelphia 76ers","home_team":"Milwaukee Bucks","id":"3","ml_conf":"72.1%","ml_pred":"Milwaukee Bucks","ou_conf":"54.5%","ou_pred":"UNDER 220.5"},{"away_team":"Dallas Mavericks","home_team":"Oklahoma City Thunder","id":"4","ml_conf":"78.7%","ml_pred":"Oklahoma City Thunder","ou_conf":"65.5%","ou_pred":"UNDER 236.5"},{"away_team":"New York Knicks","home_team":"Portland Trail Blazers","id":"5","ml_conf":"74.3%","ml_pred":"New York Knicks","ou_conf":"66.5%","ou_pred":"UNDER 206"}])
    };
    useEffect(() => {
