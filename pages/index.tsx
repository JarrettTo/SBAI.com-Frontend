...
const HomePage = () => {
    ...
    const fetchGamePredictions = async () => {
        ...
        setGamePreds([{"away_team":"Charlotte Hornets","home_team":"Detroit Pistons","id":"0","ml_conf":"54.8%","ml_pred":"Charlotte Hornets","ou_conf":"61.2%","ou_pred":"UNDER 215.5"},{"away_team":"Phoenix Suns","home_team":"Cleveland Cavaliers","id":"1","ml_conf":"61.3%","ml_pred":"Cleveland Cavaliers","ou_conf":"64.5%","ou_pred":"UNDER 221"},{"away_team":"Dallas Mavericks","home_team":"Chicago Bulls","id":"2","ml_conf":"51.4%","ml_pred":"Chicago Bulls","ou_conf":"58.6%","ou_pred":"UNDER 233"},{"away_team":"Golden State Warriors","home_team":"San Antonio Spurs","id":"3","ml_conf":"65.4%","ml_pred":"Golden State Warriors","ou_conf":"62.1%","ou_pred":"OVER 226.5"},{"away_team":"Toronto Raptors","home_team":"Denver Nuggets","id":"4","ml_conf":"80.5%","ml_pred":"Denver Nuggets","ou_conf":"59.0%","ou_pred":"UNDER 231"},{"away_team":"Boston Celtics","home_team":"Portland Trail Blazers","id":"5","ml_conf":"77.1%","ml_pred":"Boston Celtics","ou_conf":"80.5%","ou_pred":"UNDER 217"}])
    };
    useEffect(() => {
