...
const HomePage = () => {
    ...
    const fetchGamePredictions = async () => {
        ...
        setGamePreds([{"away_team":"Charlotte Hornets","home_team":"Orlando Magic","id":"0","ml_conf":"80.8%","ml_pred":"Orlando Magic","ou_conf":"62.1%","ou_pred":"UNDER 203.5"},{"away_team":"Houston Rockets","home_team":"Washington Wizards","id":"1","ml_conf":"69.2%","ml_pred":"Houston Rockets","ou_conf":"70.0%","ou_pred":"OVER 228"},{"away_team":"New Orleans Pelicans","home_team":"Brooklyn Nets","id":"2","ml_conf":"68.3%","ml_pred":"New Orleans Pelicans","ou_conf":"59.0%","ou_pred":"UNDER 215.5"},{"away_team":"Dallas Mavericks","home_team":"San Antonio Spurs","id":"3","ml_conf":"69.6%","ml_pred":"Dallas Mavericks","ou_conf":"56.2%","ou_pred":"UNDER 233.5"},{"away_team":"Denver Nuggets","home_team":"Minnesota Timberwolves","id":"4","ml_conf":"65.1%","ml_pred":"Minnesota Timberwolves","ou_conf":"79.2%","ou_pred":"UNDER 213.5"}])
    };
    useEffect(() => {
