...
const HomePage = () => {
    ...
    const fetchGamePredictions = async () => {
        ...
        setGamePreds([{"away_team":"Memphis Grizzlies","home_team":"Brooklyn Nets","id":"0","ml_conf":"60.4%","ml_pred":"Brooklyn Nets","ou_conf":"82.0%","ou_pred":"OVER 209"},{"away_team":"Portland Trail Blazers","home_team":"Minnesota Timberwolves","id":"1","ml_conf":"83.7%","ml_pred":"Minnesota Timberwolves","ou_conf":"67.0%","ou_pred":"OVER 211.5"},{"away_team":"LA Clippers","home_team":"Milwaukee Bucks","id":"2","ml_conf":"67.0%","ml_pred":"Milwaukee Bucks","ou_conf":"69.9%","ou_pred":"UNDER 228"},{"away_team":"Washington Wizards","home_team":"Utah Jazz","id":"3","ml_conf":"73.5%","ml_pred":"Utah Jazz","ou_conf":"63.1%","ou_pred":"UNDER 238"},{"away_team":"Chicago Bulls","home_team":"Sacramento Kings","id":"4","ml_conf":"62.3%","ml_pred":"Sacramento Kings","ou_conf":"64.2%","ou_pred":"UNDER 227.5"},{"away_team":"Oklahoma City Thunder","home_team":"Los Angeles Lakers","id":"5","ml_conf":"55.6%","ml_pred":"Los Angeles Lakers","ou_conf":"80.1%","ou_pred":"UNDER 237.5"}])
    };
    useEffect(() => {
